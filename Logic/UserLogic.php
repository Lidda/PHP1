<?php
	...
	class UserLogic {
		...
		function InsertUser($email, $password, $firstName, $lastName, $registrationDate, $birthDate, $townName, $mayorPic){
			return $this->userDAL->InsertUserDB($email, $password, $firstName, $lastName, $registrationDate, $birthDate, $townName, $mayorPic);
		}
